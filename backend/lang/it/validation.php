...
return [
    ...
    */
    ...
    'date_format' => 'Il campo ha un formato data non valido', // :format
    ...
    'password' => [
        ...
        'uncompromised' => 'La password inserita non è sicura. Scegliene un altra più complicata. ',
    ],
    'decimal' => 'Il campo deve essere un numero decimale',
    /*
    |--------------------------------------------------------------------------
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Custom Rules dieffetech
    |--------------------------------------------------------------------------
    |
    | Imposta qui le regole di validazione custom
    |
    */

    'fiscal_code' => 'Il codice fiscale :value non è valido.',
];
