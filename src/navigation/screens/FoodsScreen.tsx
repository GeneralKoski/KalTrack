    ...
    <View style={styles.root}>
      ...
      <SafeAreaView edges={["top", "left", "right"]} style={styles.safe}>
        ...
        <View style={styles.header}>
          ...
          {/* Il bottone del catalogo NON sta qui, e non e' una dimenticanza:
              questa schermata legge `searchMyFoods`, che esclude i seed,
              quindi un aggiornamento del catalogo non ne cambierebbe una
              riga - si premeva un comando il cui effetto era invisibile
              dov'era premuto. Vive in `FoodCatalogScreen`, che il catalogo lo
              mostra. */}
